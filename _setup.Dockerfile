...
CMD python -m pip install --upgrade pip -i http://pypi.douban.com/simple --trusted-host pypi.douban.com\
    && pip install -r /bot/requirements.txt -i https://pypi.tuna.tsinghua.edu.cn/simple \
    && pip install websockets --upgrade -i https://pypi.tuna.tsinghua.edu.cn/simple && python main.py
